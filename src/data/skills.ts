...
export const skills: Skill[] = [
  ...
  { id: 'operating-systems', label: 'Operating Systems', category: 'systems', summary: 'I have studied process execution, scheduling, protection, and the core abstractions that organize operating system behavior.' },
  { id: 'synchronization', label: 'Synchronization', category: 'systems', summary: 'I have worked with concurrency control, coordination between threads or processes, and the reasoning needed to avoid race conditions.' },
  { id: 'memory-management', label: 'Memory Management', category: 'systems', summary: 'I have studied memory organization, virtual memory, allocation behavior, and the tradeoffs involved in managing protected address spaces.' },
  { id: 'file-systems', label: 'File Systems', category: 'systems', summary: 'I have studied how storage is organized through files, directories, metadata, inodes, and protected access patterns.' },
